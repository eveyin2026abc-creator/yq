...
# Wave A: tests/ -m "not npu and not benchmark and not network" (-n up to 128 --dist worksteal, coverage).
...
export MSMODELING_NIGHTLY_XDIST_WORKERS="${MSMODELING_NIGHTLY_XDIST_WORKERS:-128}"
