...
| `msmodeling --disable-tab-completion` | Disable Tab completion | Removes the msModeling-managed completion block from `~/.bashrc` and deletes `$HOME/.local/share/msmodeling/completion.bash` generated by `msmodeling -tab`. |
